...
```env
BOT_TOKEN=8888970435:AAG61pfqG9QYlAm453Z0UuV24dSM8D0YLzI        ← токен от @BotFather (длинная строка с двоеточием)
...
4. Настройки:
   ...
   - **Branch:** `main`
   - **Runtime:** Python 3
   - **Python Version:** `3.11.11` ← **обязательно**, не 3.14!
...
| `pydantic-core` / `maturin failed` при сборке | В Render → Settings → **Python Version** = `3.11.11` (не 3.14), затем Redeploy |
